...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido_blanco" runat="server">
    ...
    <h3><i class="fa fa-angle-right"></i>Gestion de Especialistas</h3>
        <input type="button" value="Nueva Persona" runat="server" class="btn btn-theme btn-block" name="btn_agregarpersona" OnClick="location.href = '../../FormsPages/CRUD/Agregar_Usuarios.aspx'">
        <br />
