...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido_blanco" runat="server">
     <form runat="server"> <h3><i class="fa fa-angle-right"></i> EDICION ESPECIALISTA</h3>
         ...
         <br />
         <asp:Button class="btn btn-theme btn-block" type="submit" runat="server" OnClick="ModificarDatos" Text="Modificar Especialista" ></asp:Button>
         <br />
         <asp:Button class="btn btn-theme btn-block" type="submit" runat="server" OnClick="EliminarEspecialistas" Text="Eliminar Especialista"></asp:Button>
       <div class="row mt">
        <div class="col-lg-12">
