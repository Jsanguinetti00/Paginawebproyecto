<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.Master" AutoEventWireup="true" CodeBehind="Agregar_Usuarios.aspx.cs" Inherits="Diabetes_Final.FormsPages.CRUD.Agregar_Usuarios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph_heder_blanc" runat="server">
    <title>Nuevo Usuario || P.E.D 7 PASOS</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido_blanco" runat="server">
     <form runat="server"> <h3><i class="fa fa-angle-right"></i> Agregar Usuario</h3>
       <div class="row mt">
        <div class="col-lg-12">
