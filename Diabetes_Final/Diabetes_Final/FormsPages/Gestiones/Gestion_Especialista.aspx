...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido_blanco" runat="server">
    ...
    <h3><i class="fa fa-angle-right"></i>GESTION DE ESPECIALISTAS</h3>
        <input type="button" value="Nuevo Especialista" runat="server" class="btn btn-theme btn-block" name="btn_agregarpersona" OnClick="location.href = '../../FormsPages/CRUD/Agregar_Especialista.aspx'">
        <br />
